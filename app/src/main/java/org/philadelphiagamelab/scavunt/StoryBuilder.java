...
public class StoryBuilder {
    ...
    public static ArrayList<EventCluster> getClusters() {
        ...
        Task event1Video = new Task("video", Task.Type.RECEIVE_VIDEO, R.raw.test_video, true);
        Task event1Text = new Task("text", Task.Type.RECEIVE_TEXT, R.string.testString, true);
        ...
        Task event2Audio = new Task("audio", Task.Type.RECEIVE_AUDIO, R.raw.space_cruise, true);
        ...
        Task event3Text = new Task("text", Task.Type.RECEIVE_TEXT, R.string.testString, true);
        ...
        Task event4Image1 = new Task("image", Task.Type.RECEIVE_IMAGE, R.drawable.ic_launcher, true);
        Task event4Image2 = new Task("image", Task.Type.RECEIVE_IMAGE, R.drawable.ic_launcher, true);
